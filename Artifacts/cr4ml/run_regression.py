...
def initParser():
  ...
  parser.add_argument('-ci', '--coreset_identifier', default='normal')
...
if __name__ == "__main__":
  ...
  cr4ml_params = {"model_name": args.model_name,
                    ...
                    "coreset_identifier": args.coreset_identifier}

  start_time = time.time()
  cr4ml = CR4ML(dataset_params, cr4ml_params)
  cr4ml.fit(X_train_dirty, y_train, X_test, y_test, X_train_clean)
